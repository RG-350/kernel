...
#if defined(CONFIG_LCD_TM370LN4309) && !defined(CONFIG_GPIO_GOPHER2) || defined(CONFIG_LCD_TM370LN4309) && !defined(CONFIG_GPIO_PAPK3)
	sprintf(buf + strlen(buf), "480x272 TM370LN4309\n");
#elif defined(CONFIG_LCD_TM370LN4309) && defined(CONFIG_GPIO_GOPHER2)
	sprintf(buf + strlen(buf), "GOPHER2 TM370LN4309\n");
#elif defined(CONFIG_LCD_TM370LN4309) && defined(CONFIG_GPIO_PAPK3)
	sprintf(buf + strlen(buf), "PAPK3PL TM370LN4309\n");
